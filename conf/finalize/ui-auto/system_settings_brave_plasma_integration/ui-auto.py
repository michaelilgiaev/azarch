...
write("Brave")
click('ui-path/system_settings_screen_locking/3_Brave_Browser_App.png')
time.sleep(20)
click('ui-path/system_settings_screen_locking/4_Brave_Plasma_Integration_Icon.png', mouse_button='right')
click('ui-path/system_settings_screen_locking/5_Brave_Plasma_Integration_Do_Not_Show_Button.png')
click('ui-path/system_settings_screen_locking/6_Brave_Browser_Task.png')
click('ui-path/system_settings_screen_locking/7_Brave_Browser_Close_Button.png')
