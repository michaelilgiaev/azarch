...
Only specification_classify is imported (for CATEGORY_ORDER and AZARCH_CONFIGURED); the
...
def render(packages, resolved, tiers, tags, glance, svg_rel):
    ...
    d.w(f"Az'arch is [Arch Linux](https://archlinux.org) -- rolling release, "
        f"`x86_64` -- with a curated package set and Az'arch branding/configuration on "
