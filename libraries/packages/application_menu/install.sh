...
#        usage.py actions.py editing.py xfocus.py daemon.py test_menu.py + panel_icon.py
...
LIB_MODULES="menu.py applist.py widgets.py theme.py apps.py winwatch.py icons.py usage.py actions.py editing.py xfocus.py daemon.py test_menu.py panel_icon.py"
