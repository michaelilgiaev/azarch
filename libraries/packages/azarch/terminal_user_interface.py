#!/usr/bin/env python3
"""azarch guest command line interface -- the bare-`azarch` launcher for the C TERMINAL UI.
...
/usr/local/lib/azarch/azarch) so it drives the terminal with raw ANSI + termios and
...
# The compiled C UI binary (built + installed by packages.azarch.terminal_user_interface_build.build_terminal_user_interface; a test
...
TERMINAL_USER_INTERFACE_BIN = "/usr/local/lib/azarch/azarch"
