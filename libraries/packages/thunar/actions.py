...
def link_script() -> str:
    ...
    return """\
#!/usr/bin/env bash
# Az'arch `link` helper. Generated by packages/thunar (edit the Python, not this file).
...
<!-- Az'arch Thunar custom actions. Generated by packages/thunar (edit the Python, not
