...
# modifications/home_directory): "I WANT FULL ACTUAL PATHS, /home/main/.local/
# share/Trash/files/". The sidebar bookmarks already point at resolved targets
# (modifications/thunar/sidebar), so the shortcut route is correct -- but
...
# patch. modifications/thunar/settings still ships misc-resolve-links=true too, so
