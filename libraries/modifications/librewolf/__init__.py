"""LibreWolf configuration modification -- Az'arch browser policy overrides.
...
// modifications/librewolf.py (edit the Python, not this file). It ONLY changes the prefs
...
# --- Emit plan --------------------------------------------------------------
# Declarative map (builder -> dest -> mode -> owner), mirroring modifications/openbox.PLAN
