...
# modifications/gimp.py (edit the Python, not this file). GIMP reads these keys over its
...
# config alone was missing before (see modifications/gimp.py GIMP_CONFIG_VERSION).
