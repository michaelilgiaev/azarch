...
# beside this module under modifications/gedit/ (the same "sources next to the build-wiring
...
GEDIT_PLUGIN_SRC_DIR = paths.MODIFICATIONSDIR / "gedit"
...
def desktop_entry() -> str:
    ...
    return """\
[Desktop Entry]
# Az'arch notepad-mode gedit launcher. Generated by modifications/gedit.py (edit the Python,
...
def gschema_override() -> str:
    ...
    return f"""\
# Az'arch gedit override -- notepad mode. Generated by modifications/gedit.py (edit the Python,
...
# iterates for modifications/openbox and modifications/librewolf. Three root-owned SYSTEM files
