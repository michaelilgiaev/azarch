...
modifications/vlc.py suppresses VLC's first-run privacy dialog:
...
modifications/vlc -- one HOME file, owner="home".
"""
...
<!-- Az'arch LibreOffice overrides: skip the first-run and introduction popups (the
     ...
     What's New, online update check). Generated by modifications/libreoffice.py (edit the
...
# for modifications/vlc and modifications/openbox. One HOME file (owner="home"): compiler.py chowns it
