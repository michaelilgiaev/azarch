...
/etc/xdg/Thunar/uca.xml) with exactly the actions Az'arch wants (PROMPT task 2):
  ...
  3. Open Terminal Here -- on any folder / background, opens kitty (the Az'arch terminal) in
...
gedit" (no quotes): the gettext .mo override (modifications/thunar/locale) relabels the
