...
THE PROBLEM. GTK bookmarks are a STATIC file. modifications/thunar/sidebar builds it once at
...
WIRING. The OpenBox session autostart (modifications/openbox) launches
...
# by modifications/thunar/live_sidebar (edit the Python, not this file). Order: real dirs ->
...
def emit_plan() -> list[dict]:
    ...
    system script. (It is wired into session startup by modifications/openbox's autostart.)"""
    return [
        {
            "builder": sync_script,
