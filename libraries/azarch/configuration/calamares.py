...
# (see configuration/profile.py INSTALL_DIR) and arch is x86_64, so the canonical,
...
- exec:
  ...
  # instance; its configuration is modules/shellprocess-desparse.conf (see instances:).
...
# shellprocess_conf) is defined in configuration/calamares_shellprocess.py and imported at
